...
namespace NodeEditor.Editor.Scripts.Views
{
	...
	public class GraphEditorView : VisualElement, IDisposable
	{
		...
		public Action compileRequested { get; set; }
		...
		{
			MoveTooltip(evt.localMousePosition);
		}

		private void MoveTooltip(Vector2 mousePos)
		{
			m_Tooltip.style.positionTop = mousePos.y;
			m_Tooltip.style.positionLeft = mousePos.x - 32;
		}
